...
function carregaInfo(){
    ...
    var linhaHTML = `<strong>Nome: </strong> ${objUser.nome}<br>
                    ...
                    <button type="button" class="btn btn-light" onclick="logout()">Sair <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-box-arrow-right" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
function onChangeSelectStatus(status){
    ...
    <a href="#" onclick="gerarCSV()">CSV <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-spreadsheet-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
